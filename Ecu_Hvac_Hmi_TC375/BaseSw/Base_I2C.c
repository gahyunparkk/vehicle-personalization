...
IfxI2c_I2c_Device g_i2cDevEeprom; /* I2C Slave device handle to Microchip 24AA02E48   */
...
/*********************************************************************************************************************/
/* This function initializes the I2C in master mode and configures the Microchip 24AA02E48 (EEPROM) as an I2C slave */
void init_I2C_module(void)
{
  ...
  i2cDeviceConfig.deviceAddress = EEPROM_ADDRESS << 1;
...
void read_ext_device_address(void)
{
  ...
  while (IfxI2c_I2c_write2(&g_i2cDevEeprom, &i2cTxBuffer[0], LENGTH_OF_ADDRESS) == IfxI2c_I2c_Status_nak);

  /* Read the unique MAC address */
  while (IfxI2c_I2c_read2(&g_i2cDevEeprom, &g_macAddr[0], LENGTH_OF_MAC_ADDRESS) == IfxI2c_I2c_Status_nak);
}
