...
#define SHARED_PROFILE_TOTAL_COUNT          (4U)

#define SHARED_PROFILE_INDEX_1              (0U)
#define SHARED_PROFILE_INDEX_2              (1U)
#define SHARED_PROFILE_INDEX_3              (2U)
#define SHARED_PROFILE_INDEX_EMERGENCY      (3U)
#define SHARED_PROFILE_INDEX_INVALID        (0xFFU)

#define SHARED_PROFILE_SIZE_BYTE            (8U)
#define SHARED_PROFILE_TABLE_SIZE_BYTE      (32U)
...
typedef struct
{
    ...
    uint8  ac_on_threshold;
    uint8  heater_on_threshold;
} Shared_Profile_t;

/*
 * normal profile 3개 + emergency profile 1개
 * total = 32 bytes
 */
typedef struct
{
