...
#define SHARED_CAN_MSG_ID_AB_PROFILE_IDX           (0x200U)
#define SHARED_CAN_MSG_ID_HH_PROFILE_IDX           (0x201U)
...
#define SHARED_CAN_MSG_SIZE_PROFILE_IDX            (1U)
...
#define SHARED_CAN_FRAME_SIZE_PROFILE_IDX          (1U)
...
#define SHARED_CAN_MAX_DATA_WORD_SIZE              (16U)   /* uint32[16] = 64 byte work buffer */

/*
 * Message DLC
 */
#define SHARED_CAN_MSG_DLC_SS_STATE                (SHARED_CAN_DLC_1)
#define SHARED_CAN_MSG_DLC_PROFILE_IDX             (SHARED_CAN_DLC_1)
...
static inline uint8 Shared_Can_GetPayloadSize(uint32 message_id)
{
    ...
    case SHARED_CAN_MSG_ID_HH_PROFILE_IDX:
        return SHARED_CAN_MSG_SIZE_PROFILE_IDX;
...
static inline uint8 Shared_Can_GetDlc(uint32 message_id)
{
    ...
    case SHARED_CAN_MSG_ID_AB_PROFILE_IDX:
    case SHARED_CAN_MSG_ID_HH_PROFILE_IDX:
        return SHARED_CAN_MSG_DLC_PROFILE_IDX;
...
typedef char Shared_Can_Profile_Idx_t_Size_Check[
    (sizeof(Shared_Can_Profile_Idx_t) == SHARED_CAN_MSG_SIZE_PROFILE_IDX) ? 1 : -1];
